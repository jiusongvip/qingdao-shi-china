...
if (document.getElementById("homepage-map") && typeof L !== "undefined") {
  var origCreateTile = L.TileLayer.prototype.createTile;
  L.TileLayer.prototype.createTile = function (coords, done) {
    var tile = origCreateTile.call(this, coords, done);
    if (tile && tile.tagName === "IMG") tile.alt = "Qingdao street map tile";
    return tile;
  };
